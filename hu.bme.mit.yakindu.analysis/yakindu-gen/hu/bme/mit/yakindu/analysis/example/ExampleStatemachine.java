...
public class ExampleStatemachine implements IExampleStatemachine {
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_White:
				...
				break;
			case main_region_noname:
				main_region_noname_react(true);
				break;
			default:
				// $NullState$
			}
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_noname:
			return stateVector[0] == State.main_region_noname;
		default:
			return false;
		}
	}
	...
	*/
	...
	/* 'default' enter sequence for state noname */
	private void enterSequence_main_region_noname_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_noname;
	}
	...
	/* Default exit sequence for state noname */
	private void exitSequence_main_region_noname() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_White:
			...
			break;
		case main_region_noname:
			exitSequence_main_region_noname();
			break;
		default:
			break;
		}
		...
		if (try_transition) {
			if (react()==false) {
				if (sCInterface.black) {
					exitSequence_main_region_Black();
					enterSequence_main_region_noname_default();
				} else {
					did_transition = false;
				}
			}
	...
	private boolean main_region_noname_react(boolean try_transition) {
		boolean did_transition = try_transition;
